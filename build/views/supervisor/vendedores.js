                ...
                <div class="card col-12">                  
                    <div class="row">
                        <div class="col-sm-12 col-lg-4 col-md-4 col-xl-4">
                            ...
                            <input id="cmbSucursal" class="form-control" disabled>
                        </div>
...
function addListeners(){
    ...
    // asigna el valor de la sucursal seleccionada
    cmbSucursal.value = GlobalCodSucursal;
...
function InicializarVistaSupervisorVendedores(){
